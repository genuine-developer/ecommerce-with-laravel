  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{ route('Users') }}" class="sl-menu-link @yield('user_active')">
          <div class="sl-menu-item">
        ...
        <a href="#" class="sl-menu-link @yield('category_active')">
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('CategoryList') }}" class="nav-link">All Category</a></li>
            <li class="nav-item"><a href="{{ route('CategoryAdd') }}" class="nav-link">Add Category</a></li>
            <li class="nav-item"><a href="{{ route('SubCategoryList') }}" class="nav-link">All Sub Category</a></li>
            <li class="nav-item"><a href="{{ route('SubCategoryAdd') }}" class="nav-link">Add Sub Category</a></li>
          </ul>

        <a href="#" class="sl-menu-link @yield('attributes_active')">
          <div class="sl-menu-item">
            <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
            <span class="menu-item-label">Add Attributes</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('AddColor') }}" class="nav-link">Add Color</a></li>
    ...
    <div class="sl-mainpanel">
      <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active">@yield('breadcumb', 'Dashboard')</span>
      </nav>
    ...
    <script src="{{ asset('admin/lib/chart.js/Chart.j') }}s"></script>

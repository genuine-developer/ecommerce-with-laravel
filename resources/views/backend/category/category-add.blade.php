            ...
            <div class="col-xl-4 mg-t-25 mg-xl-t-0">
                <div class="card pd-20 pd-sm-40 form-layout">
                    <div class="text-center text-light font-weight-bold">
                        <p class="card-header bg-primary mb-3">{{ __('Add Category') }}</p>
                    </div>
                    ...
                    @if (session('category_add'))
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            <strong>{{ session('category_add') }}</strong>
                        </div>
                    @endif
                    ...
                    <form action="{{ route('CategoryPost') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                <input type="text" class="form-control @error('category_name') is-invalid @enderror" placeholder="ex: Sports" name="category_name" id="category_name">
                            </div>
                            @error('category_name')

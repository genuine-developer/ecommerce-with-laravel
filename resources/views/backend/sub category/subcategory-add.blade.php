            ...
            <div class="col-xl-4 mg-t-25 mg-xl-t-0">
                <div class="card pd-20 pd-sm-40 form-layout">
                    <div class="text-center text-light font-weight-bold">
                        <p class="card-header bg-primary mb-3">{{ __('Add Sub Category') }}</p>
                    </div>
                    @if (session('scategory_add'))
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                <span class="sr-only">Close</span>
                            </button>
                            <strong>{{ session('scategory_add') }}</strong>
                        </div>
                    @endif
                    ...
                    <form action="{{ route('SubCategoryPost') }}" method="POST">
                        ...
                        @csrf
                        <div class="row">
                            <label class="col-sm-4 form-control-label" for="subcategory_name">{{ __('Sub Category')}}<span class="tx-danger">* </span>:</label>
                            <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                <input type="text" class="form-control @error('subcategory_name') is-invalid @enderror" placeholder="ex: Sports" name="subcategory_name" id="subcategory_name">
                            </div>
                        ...
                        <div class="form-layout-footer mg-t-30 text-center">
                            <button class="btn btn-info mg-r-5">Add Sub-Category</button>
                        </div>
